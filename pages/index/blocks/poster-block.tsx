    ...
    >
      <PosterLayout>
        <PosterCard
          ...
          title={
            <>
              Банные процедуры - <span>скоро открытие</span>
            </>
          }
        ...
        <PosterCard
          ...
          title={
            <>
              Бассейн - <span>скоро открытие</span>
            </>
          }
        ...
        <PosterCard
          date="Дата 01 / 01 / 2025"
          title="Сезонная рыбалка"
          description="Приглашаем опытных рыбаков и любителей попробовать самую захватывающую рыбалку в регионе. Мы подобрали специальные программы ловли под каждый интерес и навык каждого посетителя."
