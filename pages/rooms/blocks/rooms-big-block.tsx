    ...
    <Section backgroundColor="dark-gray" doublePaddingTop>
      <CardLayout variant="m">
        ...
        <CardRoomBig
          ...
          title="Юрта-Хан"
          description="Дoм 48 кв.м c oтдeльной спальнeй вмещает 4х взpоcлых и 1 peбенка. Hoвый дoм на бepeгу Boлги в Астрaxaни на территоpии cвeжепocтpоеннoгo эко-oтeля Rivеr&Fish приглашaет любитeлей увлeкательной рыбалки, oхoты и oтдыxа в кoмпaнии друзей и близких!"
          square="Площадь: 48 м²"
          peoples="2-5 человек"
          bedrooms="1 спальня"
          lounge="1 гостиная"
