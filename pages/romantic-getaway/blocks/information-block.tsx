    ...
    <Section backgroundColor="dark-gray" align="center" doublePaddingTop>
      <InformationBanners>
        ...
        <InformationDescription
          ...
          description2="Сотрудники отеля помогут организовать все детали вашего романтического путешествия. Вас ждут специально подготовленные номера с цветами и шампанским, расслабляющие спа-процедуры для двоих и уютные вечера у открытого огня"
