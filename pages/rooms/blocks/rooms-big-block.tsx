        ...
        <CardLayout variant="m">
            ...
            <CardModalContentRooms
              ...
              description={
                <>
                  ...
                  <br></br> <br></br> Дом 36 кв.м вмешает 4х взpocлых и 1
          ...
          >
            <CardModalContentRooms
              ...
              description={
                <>
                  7 номеров с односпальными кроватями, кондиционер в каждом
                  номере. <br></br>
                  ...
                  аутентичная атмосфера - как в старых добрых базах, только
                  комфортнее. <br></br>
                ...
                <CardModalContentRooms
                  ...
                  description={
                    <>
                      ...
                      рыбалку, они будут чувствовать себя комфорта и в
                ...
                <CardModalContentRooms
                  ...
                  description={
                    <>
                      ...
                      собственная терраса и мангальная зона. <br></br> <br></br>
                      Особенности отдыха Каждый дом представляет собой отдельное
                      строение, что позволяет проводить время в кругу близких,
                      не мешая другим. На территории имеется паковка с
                      видеонаблюдением для автомобилей. Удобный спуск к воде. В
                      доме можно спокойно оставить семью, а самому уехать на
                      рыбалку, они будут чувствовать себя комфорта и в
