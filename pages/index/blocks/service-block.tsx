    ...
    <Section title="Услуги">
      <CardServiceLayout>
        <CardService
          ...
          title="Охота"
          subtitle="Вы сможете поохотиться на лисиц, волков, шакалов, енотовидных собак, зайцев-русаков, водоплавающую дичь (утка, гусь, лебедь), фазанов, куропаток"
        />
        <CardService
        ...
        <CardService
          ...
          title="Аренда лодок"
          subtitle="Мы предлагаем Вам современные лодки для комфортных прогулок по реке."
        />
        <CardService
          imageLink1x={cardService4}
          imageLink2x={cardService4}
          title="Ресторан Щепа - скоро открытие"
