...
import BannerHalfImage3 from "../assets/banner-half-3.webp";
    ...
    <Section backgroundColor="dark-gray" align="center" doublePaddingTop>
      <InformationBanners>
        <BannerHalf>
          ...
          />
          <BannerSlideHalf
            imageLink1x={BannerHalfImage3}
            imageLink2x={BannerHalfImage3}
          />
        </BannerHalf>
        <InformationDescription
          description1="Команда River-Fish – это люди, которые проехали в путешествиях по России несколько десятков тысяч километров, побывали во всех знаменитых заповедниках и заказниках в поиске открытий, совместных впечатлений от путешествия, новых вкусов и эмоций."
          description2="Весь наш опыт мы решили воплотить в авторском эко-отеле в одном из самых красивых мест нашей Родины – в русле реки Енотаевка. River-Fish это пространство, где мы сделаем ваш отдых идеальным. Мы позаботились о всех мелочах, чтобы ничто не отвлекало вас от главного – красоты момента и удовольствия."
