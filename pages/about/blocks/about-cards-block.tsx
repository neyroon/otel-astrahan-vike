    ...
    <Section align="center" backgroundColor="dark-gray">
      <AttendanceCards>
        ...
        <CardAttendance
          ...
          description="Погрузитесь в мир охоты в живописной Астрахани, остановившись в нашем эко-отеле. Вы сможете поохотиться под руководством потомственного егеря Михаила."
          linkHref="/hunting"
        />
        <CardAttendance
